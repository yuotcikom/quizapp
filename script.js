...
function showResult(){
    ...
    if (userScore > 10){ // if user scored more than 3
        ...
        let scoreTag = '<span>The beast 💪 You got <p>'+ userScore +'</p> / <p>'+ questions.length +'</p></span>';
        ...
        let scoreTag = '<span>Pull up your socks 😐, You got only <p>'+ userScore +'</p> / <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
